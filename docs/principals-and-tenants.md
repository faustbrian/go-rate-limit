...
go-authentication Principal satisfies that contract, so authentication does
...
go-authorization remains responsible for permission checks. Never infer tenant
