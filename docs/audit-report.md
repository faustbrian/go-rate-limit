...
correctness, availability, and resource properties of go-rate-limit. Evidence
...
The blocking benchmark gate takes three samples and enforces latency, bytes,
and allocations for hot-key, high-cardinality, and batch paths. The July 17
Apple M4 Max samples were below 1.1 microseconds for memory hot-key, below 0.9
microseconds for bounded cardinality churn, and below 0.7, 5.2, 22.5, and 95
microseconds for batch sizes 1, 16, 64, and 256 respectively.
